...
/** Uppercase tracked label marking a new hierarchy level within the form. */
function FormSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-3 sm:col-span-2">
      <TechLabel className="border-b border-border pb-1.5 text-muted-foreground">{title}</TechLabel>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        ...
        <div
          className="grid max-h-[65vh] gap-6 overflow-y-auto pr-1 sm:grid-cols-2"
          data-lenis-prevent
        >
          ...
          <FormSection title="Media">
            <div className="sm:col-span-2">
              <ImageDropzone label="Product image" imageUrl={imageUrl} onChange={setImageUrl} />
            </div>
          </FormSection>
