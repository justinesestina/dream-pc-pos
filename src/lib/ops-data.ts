...
export const suppliers: Supplier[] = [
  {
    ...
    terms: "Net 30",
    leadTimeDays: 5,
    categories: ["AMD", "ASUS", "Gigabyte", "Samsung", "Kingston", "Corsair", "DeepCool", "Arctic", "TP-Link", "Logitech", "Palit", "GALAX"],
    status: "active",
    rating: 4.6,
  ...
  },
  {
    ...
    terms: "Net 15",
    leadTimeDays: 3,
    categories: ["Intel", "MSI", "ASUS", "NVIDIA", "Gigabyte", "Samsung", "Seagate", "WD", "Crucial", "XFX", "Sapphire", "Colorful", "GALAX"],
    status: "active",
    rating: 4.2,
  ...
  },
  {
    ...
    leadTimeDays: 7,
    categories: ["Cooler Master", "DeepCool", "Corsair", "Thermaltake", "NZXT", "Lian Li", "Fractal Design", "Montech", "Phanteks", "SilverStone", "In Win"],
    status: "active",
    rating: 3.9,
  },
  {
  ...
  },
  {
    ...
    terms: "Net 15",
    leadTimeDays: 4,
    categories: ["Logitech", "Razer", "SteelSeries", "HyperX", "AOC", "BenQ", "ASUS", "T-Force", "SADES", "Cougar"],
    status: "inactive",
    rating: 3.4,
