  ...
  const columns: Column<PurchaseOrder>[] = [
    {
      key: "id",
      header: "PO ID",
      cell: (r) => <Mono className="text-foreground">{r.id}</Mono>,
      sortValue: (r) => r.id,
    },
    {
      key: "created",
      header: "Created",
      cell: (r) => <span className="mono text-xs">{dateShort(r.createdAt)}</span>,
      sortValue: (r) => r.createdAt,
    },
    {
      key: "expected",
      header: "Expected",
      cell: (r) => <span className="mono text-xs">{dateShort(r.expectedAt)}</span>,
    ...
    <div className="space-y-5 p-4 sm:p-6">
      ...
      <Section title="Contact">
        ...
        <div className="px-4 pb-4">
          <p className="label-tech">Brands supplied</p>
          <div className="mt-1 flex flex-wrap gap-1">
            <BrandChips productIds={supplier.productIds} products={products} />
          </div>
        </div>
        {supplier.notes && (
